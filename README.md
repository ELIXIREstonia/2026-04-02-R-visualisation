...
The main document of the lecture is the [2026-04-02-R-visualisation.Rmd](2026-04-02-R-visualisation.Rmd) R markdown document. R markdown allows code (examples) and explanation / documentation to be in the same document in a nicely formatted, well structured manner.
